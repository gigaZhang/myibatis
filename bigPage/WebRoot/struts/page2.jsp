...
<script type="text/javascript">
	$(function(){
		$("table").bigPage({ajaxData:{url:"data2.action",batch:true},pageSize:7,cssWidgets:["appendToTable","eventColor"],callback:function(){
...
<pre>
	$(function(){
		$("tTable").bigPage({ajaxData:{url:"data2.action",batch:true},pageSize:7,cssWidgets:["appendToTable","eventColor"],callback:function(){
			$("#curentPage").html(bigPage.toPage());
			$("#count").html(bigPage.pageNumber());		
		}});
	})	
